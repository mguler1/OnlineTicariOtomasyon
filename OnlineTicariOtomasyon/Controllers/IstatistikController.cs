...
namespace OnlineTicariOtomasyon.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        {
            var sorgu = from x in c.Caris group x by x.CariSehir into g select new SinifGrup {
                Sehir = g.Key,
                Sayi = g.Count()
            };
        ...
        {
            var sorgu2 = from x in c.Personels group x by x.Departman.DepartmanAd into g select new SinifGrup2 { departman = g.Key, sayi = g.Count() }; 
       ...
       public PartialViewResult partial3()
        ...
        public PartialViewResult partial4()
        {
            ...
            {
                var sorgu6 = from x in c.Uruns group x by x.Kategori.KategoriAd into g select new SinifGrup4 { kategori = g.Key, sayi = g.Count() };
