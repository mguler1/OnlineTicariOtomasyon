...
namespace OnlineTicariOtomasyon.Controllers
{
    public class KategoriController : Controller
    {
        ...
        {
            var ktgr = c.Kategoris.Find(k.KategoriD);
        ...
        {
            var urunlist = (from x in c.Uruns
                            join y in c.Kategoris on x.Kategori.KategoriD equals y.KategoriD
                            where x.Kategori.KategoriD == p
                            select new
                            {
                                Text = x.UrunAd,
